...
$(document).ready(function () {
  ...
  <body>
    ...
    <div class="field">
        ...
        <div class="ui input spinner" id="spinner">
            <input type="text" class="spinner-input" name="number" id="number" placeholder="Number" value="2" />
            <div class="ui buttons vertical">
                <button type="button" class="ui button spinner-up"><i class="icon up arrow"></i>
                </button>
                <button type="button" class="ui button spinner-down"><i class="icon down arrow"></i>
                </button>
            </div>
        </div>
    </div>
